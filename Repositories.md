...
| [docker-homebridge](https://github.com/homebridge/docker-homebridge) || Releases are triggered when code is pushed to the repository. A push to a PR or Branch will push an image tagged with Branch/TAG.  To publish the latest version, simpliest approach is to create a PR, then merge it. <BR> - To Update [HOMEBRIDGE_PKG_VERSION & FFMPEG_VERSION](https://github.com/homebridge/docker-homebridge/blob/31d86debf117593fdfcc0759ce35f08f27c2cd55/Dockerfile#L11-L13) the Dockerfile needs to be updated with the latest versions.| * [homebridge-raspbian-image](https://github.com/homebridge/homebridge-raspbian-image)<BR>* [ffmpeg-for-homebridge](https://github.com/homebridge/ffmpeg-for-homebridge) |
| [homebridge-syno-spk](https://github.com/homebridge/homebridge-syno-spk) | | Github Action - `Build and Publish`<BR>Manually start the workflow and enter a new Release tag ie `1.0.46`<BR><BR>Note: Version number must not contain a v, ie `1.1.0` and not `v1.1.0`| 

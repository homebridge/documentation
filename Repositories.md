...
| [docker-homebridge](https://github.com/homebridge/docker-homebridge) || Releases are triggered when code is pushed to the repository. A push to a PR or Branch will push an image tagged with Branch/TAG.  To publish the latest version, simpliest approach is to create a PR, then merge it. <BR> - To Update [HOMEBRIDGE_PKG_VERSION & FFMPEG_VERSION](https://github.com/homebridge/docker-homebridge/blob/31d86debf117593fdfcc0759ce35f08f27c2cd55/Dockerfile#L11-L13) | * [homebridge-raspbian-image](https://github.com/homebridge/homebridge-raspbian-image)<BR>* [ffmpeg-for-homebridge](https://github.com/homebridge/ffmpeg-for-homebridge) |
